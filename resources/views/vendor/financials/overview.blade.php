...
<head>
    ...
    <title>Helly - Financial Overview</title>
...
<body class="bg-gradient-to-br from-gray-50 to-gray-100 font-sans min-h-screen">
    ...
    <div class="p-8">
        ...
        <div class="flex border-b border-gray-200 mb-8 space-x-6">
            <a href="{{ route('financials.overview') }}" class="finance-tab py-2 px-0 cursor-pointer font-bold text-gray-500 transition-colors duration-300 hover:text-gray-800 border-b-2 border-transparent text-chili-red border-chili-red">Overview</a>
        ...
        <div id="finance-tab-overview" class="finance-content-view">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                <div class="bg-white p-6 rounded-lg shadow-md text-center">
                    ...
                    <p id="overviewTotalRevenue" class="text-4xl font-bold text-green-600">${{ number_format($totalRevenue, 2) }}</p>
                </div>
                <div class="bg-white p-6 rounded-lg shadow-md text-center">
                    <h4 class="text-lg text-gray-500 mb-2">Outstanding A/R</h4>
                    <p id="overviewOutstandingAR" class="text-4xl font-bold text-ut-orange">${{ number_format($outstandingAR, 2) }}</p>
                </div>
                <div class="bg-white p-6 rounded-lg shadow-md text-center">
                    <h4 class="text-lg text-gray-500 mb-2">Total Expenses (YTD)</h4>
                    <p id="overviewTotalExpenses" class="text-4xl font-bold text-red-600">${{ number_format($totalExpenses, 2) }}</p>
                </div>
                <div class="bg-white p-6 rounded-lg shadow-md text-center">
                ...
                <div class="bg-white p-6 rounded-lg shadow-md text-center md:col-span-1 lg:col-span-1">
                    <h4 class="text-lg text-gray-500 mb-2">Equipment Utilization (YTD)</h4>
                    <p id="overviewEquipmentUtilization" class="text-4xl font-bold text-ut-orange">{{ number_format($utilizationRate, 1) }}%</p>
                </div>
            </div>
        ...
        {{-- Conceptual tabs for reports, expenses, settings will be here --}}
        {{-- For now, they are linked via full page redirects --}}
