...
<head>
    ...
    <title>Helly - Vendor Login</title>
        ...
        <div class="w-full max-w-md relative z-10 slide-in">
            <div class="glass-morphism rounded-2xl p-8 shadow-2xl">
                <div class="text-center mb-8">
                    <h2 class="text-3xl font-bold text-white mb-2">Vendor Portal</h2>
                    <p class="text-white/80">Sign in to your vendor account</p>
                </div>
                ...
                <form method="POST" action="{{ route('vendor.login.attempt') }}" class="space-y-6">
                    @csrf {{-- CSRF token for security --}}

                    <div class="input-group">
                        <input type="email" id="loginEmail" name="email" required 
                               class="w-full px-4 py-3 placeholder-transparent focus:outline-none focus:border-white focus:bg-white/30 transition"
                ...
                <div class="mt-6 text-center">
                    <p class="text-white/80 text-sm">
                        ...
                        <a href="{{ route('vendor.register') }}" class="text-white font-semibold hover:underline">Sign up here</a>
                    </p>
                </div>
            </div>
        </div>
