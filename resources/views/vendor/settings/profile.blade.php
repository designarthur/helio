...
@section('content')
    ...
    <div class="flex border-b border-gray-200 mb-8 space-x-6">
        ...
        <span class="settings-tab py-2 px-0 cursor-pointer font-bold text-gray-500 transition-colors duration-300 hover:text-gray-800 border-b-2 border-transparent text-[#EA3A26] border-[#EA3A26]" data-tab="profile">Profile</span>
    ...
    <div id="settings-tab-content-profile" class="tab-content bg-white p-6 rounded-lg shadow-md">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            document.querySelector('.settings-tab[data-tab="profile"]').classList.add('text-[#EA3A26]', 'border-[#EA3A26]');
            document.querySelector('.settings-tab[data-tab="profile"]').classList.remove('text-gray-500', 'border-transparent');
        });
    </script>
@endsection